    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col sm:flex-row justify-between items-center gap-4 bg-white p-4 rounded-xl border border-gray-100 shadow-sm">
        <p className="text-sm text-gray-500">
          Mostrando <span className="font-semibold text-gray-900">{drawings.length}</span> de <span className="font-semibold text-gray-900">{totalItems}</span> resultados
        </p>
      ...
      {drawings.length > 0 ? (
        ...
        <div className="text-center py-20 bg-white rounded-xl border border-dashed border-gray-300">
          <p className="text-gray-500 text-lg">Nenhum desenho encontrado com estes filtros.</p>
          <Button 
            variant="link" 
